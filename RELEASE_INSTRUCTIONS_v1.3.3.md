# Instrucciones para crear Release v1.3.3 en GitHub

## 📦 Archivos generados:
- `vpn-manager_1.3.3_amd64.deb` - Paquete Debian/Ubuntu
- `VPN-Manager-Linux-x64-v1.3.3.tar.gz` - Paquete Linux general

## 🚀 Pasos para crear la release:

### 1. Acceder a GitHub
- URL: https://github.com/alumno109192/vpn/releases/new?tag=v1.3.3

### 2. Configurar Release
- **Tag version:** v1.3.3 (preseleccionado)
- **Release title:** VPN Manager v1.3.3 - Enhanced auto-updater

### 3. Descripción del Release
Copiar el siguiente texto:

```markdown
## 🚀 VPN Manager v1.3.3 - Enhanced auto-updater
...
- `release/vpn-manager_1.3.3_amd64.deb`
- `release/VPN-Manager-Linux-x64-v1.3.3.tar.gz`
...
- Versión anterior: v1.3.2
- Nueva versión: v1.3.3

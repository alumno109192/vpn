...
class ConnectionObserver:
    ...
    def _update_ui(self):
        ...
        if self.state == ConnectionState.DISCONNECTED:
            ...
            # Usar el mismo icono de tick que 'Iniciar con el sistema'
            tick_icon = self.button.style().standardIcon(QStyle.SP_DialogApplyButton)
            self.tray_icon.setIcon(tick_icon)
# Instrucciones para crear Release v1.3.4 en GitHub

## 📦 Archivos generados:
- `vpn-manager_1.3.4_amd64.deb` - Paquete Debian/Ubuntu
- `VPN-Manager-Linux-x64-v1.3.4.tar.gz` - Paquete Linux general

## 🚀 Pasos para crear la release:

### 1. Acceder a GitHub
- URL: https://github.com/alumno109192/vpn/releases/new?tag=v1.3.4

### 2. Configurar Release
- **Tag version:** v1.3.4 (preseleccionado)
- **Release title:** VPN Manager v1.3.4 - Enhanced auto-updater

### 3. Descripción del Release
Copiar el siguiente texto:

```markdown
## 🚀 VPN Manager v1.3.4 - Enhanced auto-updater
...
```bash
tar -xzf VPN-Manager-Linux-x64-v1.3.4.tar.gz
cd VPN-Manager-Linux-x64-v1.3.4
python3 Main.py
```
...
- `release/vpn-manager_1.3.4_amd64.deb`
- `release/VPN-Manager-Linux-x64-v1.3.4.tar.gz`
...
- Versión anterior: v1.3.3
- Nueva versión: v1.3.4

...
class LicenseStorage:
    ...
    def is_trial_valid():
        ...
        # Email especial con validación permanente (si no tiene licencia activa)
        if data.get('email') == 'yesod3d@gmail.com' and not data.get('serial'):
            return True
    ...
    def is_license_valid():
        ...
        # Email especial con validación permanente
        if data.get('email') == 'yesod3d@gmail.com':
            return True
